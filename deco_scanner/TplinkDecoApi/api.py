...
# install with "pip install async_timeout"
...
class TplinkDecoApi:
    ...
    async def async_list_devices(self) -> dict:
        """
        List all DECO devices, ie access points
        :return: an object that contains information about the master DECO
            with a dictionary slave-devices[] that contains information about all slave devices
            and a dictionary other-devices[] that may contain any other devices of a yet unknown type (not slave or master)
            May look like this:
            {
                "custom_nickname": "Main",
                "hardware_ver": "1.0",
                "bssid_sta_2g": "",
                "software_ver": "1.0.13 Build 20231226 Rel. 64412",
                "role": "master",
                "bssid_sta_5g": "",
                "inet_status": "online",
                "nickname": "Main",
                "previous": "xx-xx-xx-xx-xx-xx",
                "device_model": "X20-DSL",
                ...
                "bssid_5g": "",
                "nand_flash": true,
                "hw_id": "78274274182346147619346139",
                ...
                "slave-devices": [
                    {
                        ...
                        "owner_transfer": true,
                        "previous": "xx-xx-xx-xx-xx-xx",
                        "bssid_5g": "xx-xx-xx-xx-xx-xx",
                        "parent_device_id": "78274274182346147619346139",
                        "ip": "192.168.1.250",
                        "software_ver": "1.6.1 Build 20231228 Rel. 53314",
                        "role": "slave",
                        "bssid_sta_5g": "xx-xx-xx-xx-xx-xx",
                        "bssid_sta_2g": "xx-xx-xx-xx-xx-xx",
                        "device_id": "274982465492645921654254",
                        "product_level": 100,
                        "hardware_ver": "3.0",
                        "inet_status": "online",
                        "support_plc": false,
                        "bssid_2g": "xx-xx-xx-xx-xx-xx",
                        "mac": "xx-xx-xx-xx-xx-xx",
                        "set_gateway_support": false,
                        "inet_error_msg": "well",
                        "connection_type": [
                            "band2_4",
                            "band5"
                        ],
                        "custom_nickname": "somename",
                        "nickname": "somename",
                        "group_status": "connected",
                        "oem_id": "947741384671846848257827582",
                        "signal_level": {
                            "band2_4": "3",
                            "band5": "2"
                        },
                        ...
                        "hw_id": "42864726486483456187451834678365",
                        "device_type": "HOMEWIFISYSTEM"
                    }
                ],
                "other-devices": []
            ...
            if len(device_list) == 1:
                ...
                for dev in device_list:
                    if dev["role"] == "master":
                        ...
                        others.append(dev)
            if (master):
                master["slave-devices"] = slaves
                master["other-devices"] = others
            return master
        except Exception as err:
    ...
    async def async_list_clients(self, deco_mac="default") -> dict:
        """
        List all DECO clients
        :deco_mac: either 'default' which will list all connected clients to all devices or
            mac of one of the devices which will list clients on that particular device
        :return: adictionary that contains information about the connected clients
            May look like this:
            [
                {
                    "mac": "xx-xx-xx-xx-xx-xx",
                    ...
                    "client_mesh": true,
                    "online": true,
                    "name": "Name of this client from the UI",
